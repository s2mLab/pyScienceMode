...
channel_1 = Channel(
    no_channel=2, name="Biceps", amplitude=150, pulse_width=100, frequency=200, device_type="RehastimP24"
)
channel_2 = Channel(
    mode="Single",
    no_channel=4,
...
stimulator = St(port="COM4", show_log=True)  # Enter the port on which the rehastimP24 is connected
